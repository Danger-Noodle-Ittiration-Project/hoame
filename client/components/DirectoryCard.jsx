...
const DirectoryCard = ({ first_name, last_name, street_address, phone }) => {
  return (
    <div className='memberCard'>
      {/* Display user's first name as card title */}
      <h2 className='messageTitle'>{first_name} {last_name}</h2>
      <p className='address'>Address: {street_address}</p>
